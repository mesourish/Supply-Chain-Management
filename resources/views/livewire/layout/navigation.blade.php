...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('finance.invoices')" wire:navigate>
                                    {{ __('Invoices') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('finance.receivables')" wire:navigate>
                                    {{ __('Receivables') }}
                                </x-dropdown-link>
                                @endcan
                                @can('view payables')
                                <x-dropdown-link :href="route('finance.payables')" wire:navigate>
                                    {{ __('Payables') }}
                                </x-dropdown-link>
                                @endcan
                            </x-slot>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('inventory.log')" :active="request()->routeIs('inventory.*')" wire:navigate>
                {{ __('Inventory Log & Analytics') }}
            </x-responsive-nav-link>
